<?php
/* $Id: german.inc.php,v 1.1.1.1 2000/11/10 04:35:55 dwilson Exp $ */
...
$strEdit		= "Ändern";
$strEmpty		= "Leeren";
$strEmptyResultSet	= "PostgreSQL lieferte ein leeres Resultset zurück (d.h. null Zeilen).";
...
$strPostgreSQLReloaded       = "PostgreSQL neu gestartet.";
$strPostgreSQLSaid           = "PostgreSQL meldet: ";
$strPostgreSQLShowStatus     = "PostgreSQL-Laufzeit-Informationen anzeigen";
$strPostgreSQLShowVars       = "PostgreSQL-System-Variablen anzeigen";
$strName		= "Name";
$strNext		= "Nächste";
$strNo			= "Nein";
...
$strReadTheDocs		= "PostgreSQL-Dokumentation zu LOAD DATA INFILE lesen";
$strRecords             = "Einträge";
$strReloadFailed        = "PostgreSQL Neuladen fehlgeschlagen.";
$strReloadPostgreSQL         = "PostgreSQL neu starten";
...
$strYes			= "Ja";
$strPostgreSQLShowProcess    = "Prozesse anzeigen";
