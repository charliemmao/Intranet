<?php
/* $Id: spanish.inc.php,v 1.1.1.1 2000/11/10 04:35:59 dwilson Exp $ */
...
$strEdit = "Editar";
$strEmpty = "Vaciar";
$strEmptyResultSet = "PostgreSQL ha devuelto un valor vac&iacute;o (i.e. cero
columnas).";
...
$strPostgreSQLReloaded = "Reinicio de PostgreSQL.";
$strPostgreSQLSaid = "PostgreSQL ha dicho: ";
$strPostgreSQLShowStatus     = "Mostrar informaci&oacute;n de marcha de
PostgreSQL";
$strPostgreSQLShowVars       = "Mostrar las variables del sistema PostgreSQL";
$strName = "Nombre";
...
$strRecords             = "Campos";
$strReloadFailed        = "El reinicio de PostgreSQL ha fallado.";
$strReloadPostgreSQL = "Reinicio de PostgreSQL";
...
$strYes = "Si" ;
$strPostgreSQLShowProcess    = "Mostrar procesos";
$strLogout              = "Salir";
