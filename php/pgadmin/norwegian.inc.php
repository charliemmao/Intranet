...
$strPostgreSQLSaid		= "PostgreSQL sa: ";
...
$strPostgreSQLReloaded	= "PostgreSQL omstartet.";
$strCreateNewDatabase	= "Opprett ny database";
$strCreate		= "Opprett";
$strReloadPostgreSQL		= "Omstart av PostgreSQL";
$strHasBeenCreated	= "er opprettet.";
$strNoTablesFound	= "Ingen tabeller i databasen.";
$strEmptyResultSet	= "PostgreSQL returnerte tomt resultat (m.a.o. ingen rader).";
$strBrowse		= "Se på";
$strSelect		= "Spørring";
$strInsert		= "Sett inn";
...
$strPrevious		= "Forrige";
$strNext		= "Neste";
$strPostgreSQLShowStatus     = "Vis PostgreSQL runtime informasjon";
$strPostgreSQLShowVars       = "Vis PostgreSQL systemvariabler";
