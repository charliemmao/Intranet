<?php
/* $Id: italian.inc.php,v 1.1.1.1 2000/11/10 04:35:56 dwilson Exp $ */
...
$strEdit		= "Modifica";
$strEmpty		= "Vuota";
$strEmptyResultSet	= "PostgreSQL ha restituito un insieme vuoto (i.e. zero righe).";
...
$strPostgreSQLReloaded	= "PostgreSQL ricaricato.";
$strPostgreSQLSaid		= "PostgreSQL ha detto: ";
$strPostgreSQLShowStatus     = "Visualizza le informazioni runtime di PostgreSQL";
$strPostgreSQLShowVars       = "Visualizza le variabili di sistema di PostgreSQL";
$strName		= "Nome";
$strNext		= "Prossimo";
$strNo			= "No";
...
$strRecords             = "Record";
$strReloadFailed        = "Ricaricamento di PostgreSQL fallito.";
$strReloadPostgreSQL		= "Ricarica PostgreSQL";
...
$strYes			= "Sì";
$strPostgreSQLShowProcess    = "Visualizza processi";
