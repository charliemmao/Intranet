<html>
<body leftmargin="20" bgcolor="#D0DCE0" text="#000000" link="#006600" vlink="#993333" alink="#CC6600" background="rlaemb.JPG">

<?php
$indexfile = "index_admin.php";
/* $Id: main.php,v 1.39 2001/08/29 07:15:40 loic1 Exp $ */
...
//echo "<h1>".$strWelcome . ' phpMyAdmin ' . PHPMYADMIN_VERSION."</h1>";
echo "<h1>".$strWelcome . ' MySQL Adminpage' ."</h1>";
...
if ($server > 0) { //<
    ...
    echo '<p><b>MySQL ' . $row_version['version'] . ' ' . $strRunning . ' ' . getenv("server_name");
...
<tr>
    <td>
        <form action="index_admin.php" target="_top">
            <select name="server">
    <?php
    echo "\n";
    reset($cfgServers);
...
// The user is allowed to create a db '
        ...
        <tr>
            <td valign="baseline"><img src="images/item.gif" width="7" height="7" alt="item" /></td>
            <td>
                <a href="sql.php?<?php echo $common_url_query; ?>&db=mysql&sql_query=<?php echo urlencode('SHOW STATUS'); ?>&display=simple">
        ...
        <tr>
            <td valign="baseline"><img src="images/item.gif" width="7" height="7" alt="item" /></td>
            <td>
                <a href="sql.php?<?php $common_url_query; ?>&db=mysql&sql_query=<?php echo urlencode('SHOW VARIABLES'); ?>&display=simple">
        ...
        <tr>
            <td valign="baseline"><img src="images/item.gif" width="7" height="7" alt="item" /></td>
            <td>
                <a href="sql.php?<?php echo $common_url_query; ?>&db=mysql&sql_query=<?php echo urlencode('SHOW PROCESSLIST'); ?>&display=simple">
        ...
        <tr>
            <td valign="baseline"><img src="images/item.gif" width="7" height="7" alt="item" /></td>
            <td>
                <a href="index_admin.php?<?php echo $common_url_query; ?>&old_usr=<?php echo urlencode($PHP_AUTH_USER); ?>" target="_top">
    ...
    else
    {
        ...
        <tr>
            <td valign="baseline"><img src="images/item.gif" width="7" height="7" alt="item" /></td>
            <td>
                <a href="sql.php?<?php echo $common_url_query; ?>&db=mysql&sql_query=<?php echo urlencode('SHOW STATUS'); ?>">
                    <?php echo $strMySQLShowStatus; ?></a>&nbsp;
                <?php echo show_docu('manual_Reference.html#SHOW') . "\n"; ?>
            </td>
        </tr>
        ...
        <tr>
            <td valign="baseline"><img src="images/item.gif" width="7" height="7" alt="item" /></td>
            <td>
                <a href="sql.php?<?php echo $common_url_query; ?>&db=mysql&sql_query=<?php echo urlencode('SHOW VARIABLES'); ?>">
                    <?php echo $strMySQLShowVars; ?></a>&nbsp;
                <?php echo show_docu('manual_Performance.html#Performance') . "\n"; ?>
            </td>
        </tr>
        ...
        <tr>
            <td valign="baseline"><img src="images/item.gif" width="7" height="7" alt="item" /></td>
            <td>
                <a href="sql.php?<?php echo $common_url_query; ?>&db=mysql&sql_query=<?php echo urlencode('SHOW PROCESSLIST'); ?>">
                    <?php echo $strMySQLShowProcess; ?></a>&nbsp;
                <?php echo show_docu('manual_Reference.html#SHOW') . "\n"; ?>
            </td>
        </tr>
...
?>
    ...
    <!-- phpMyAdmin related links MySQL Adminpage-->
    <td valign="top" align="left">
        <table border=0>
        <tr>
            <th colspan="2">&nbsp;</th>
...
if (empty($cfgLang)) {
    ?>
        ...
        <tr>
            <td valign="baseline"><img src="images/item.gif" width="7" height="7" alt="item" /></td>
            <td>
            <!--     <form method="post" action="index_admin.php" target="_top">
                    <input type="hidden" name="server" value="<?php echo $server; ?>" />
                    Language:
        ...
        <tr>
            ...
            <td>
                <a href="http://phpmyadmin.sourceforge.net/" target="_new">
                    <?php echo $strHomepageSourceforge; ?>
</a><br />
