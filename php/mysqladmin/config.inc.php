...
/**
 * MySQL Adminpage Configuration File
 *
...
include("find_developer.inc");
$cfgServers[1]['user']          = $dinfo[0];      // MySQL user (only needed with basic auth)
$cfgServers[1]['password']      = $dinfo[1];      // MySQL password (only needed with basic auth)
...
// to any one of them to autoconnect to that server when MySQL Adminpage is started,
