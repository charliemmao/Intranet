...
<body bgcolor="#D0DCE0">
    <?php
/* $Id: left.php,v 1.33 2001/08/29 18:19:13 loic1 Exp $ */
...
if ($num_dbs > 1) {
    ...
    for ($i = 0; $i < $num_dbs; $i++) {
        ...
        <a class="item" href="db_details.php?<?php echo $common_url_query; ?>" onclick="if (capable) {expandBase('el<?php echo $j; ?>', true); return false;}">
            <img name="imEx" id="el<?php echo $j; ?>Img" src="plus.gif" border="0" width="9" height="9" alt="+" /></a>
            <?php
        } else {
            echo "\n";
            ?>
        <img name="imEx" src="minus.gif" border="0" width="9" height="9" />
            <?php
        }
        echo "\n";
        ?>
    ...
    <div id="el<?php echo $j;?>Child" class="child" style="margin-bottom: 5px">
        ...
        for ($j = 0; $j < $num_tables; $j++) {
            ...
            echo "\n";
            ?>
        <nobr><img src="spacer.gif" border="0" width="9" height="9" alt="" />
        <a target="phpmain" href="sql.php?<?php echo $common_url_query; ?>&table=<?php echo urlencode($table); ?>&sql_query=<?php echo urlencode('SELECT * FROM ' . backquote($table)); ?>&pos=0&goto=tbl_properties.php">
            <img src="browse.gif" border="0" alt="<?php echo "$strBrowse: $table"; ?>" /></a>&nbsp;
        <a class="tblItem" target="phpmain" href="tbl_properties.php?<?php echo $common_url_query; ?>&table=<?php echo urlencode($table); ?>">
