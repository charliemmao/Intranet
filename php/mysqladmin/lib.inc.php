...
if (!defined('__LIB_INC__')){
    ...
    function auth()
    {
        ...
        header('WWW-authenticate: basic realm="MySQL Adminpage on ' . $GLOBALS['cfgServer']['host'] . '"');
        ?>
...
<div align="left">
    ...
    <tr>
        <td bgcolor="<?php echo $GLOBALS['cfgBgcolorOne']; ?>">
            ...
            if (!isset($GLOBALS['show_query']) || $GLOBALS['show_query'] != 'y') {
                if (isset($GLOBALS['goto']) && $GLOBALS['goto'] == 'tbl_properties.php') {
    ...
    function show_table_navigation($pos_next, $pos_prev, $dt_result)
    {
        ...
        // $sql_query will be stripslashed in 'sql.php' if the
        ...
        ?> <a href="' . $GLOBALS['cfgManualBase'] . '/' . $link .'" target="mysql_doc"></a>
...
<tr>
    ...
    function display_table($dt_result, $is_simple = FALSE)
    {
        ...
        if (!$is_simple 
            && (!isset($SelectNumRows) || 1 < $SelectNumRows)) {
    ...
    <td>
        <a href="<?php echo $delete_url; ?>">
            ...
            if ($is_show_processlist) {
                ?>
    <td align="right">
        <a href="sql.php?db=mysql&sql_query=<?php echo urlencode('KILL ' . $Id); ?>&goto=main.php">
